// SurfaceWaterTSMonth - data object for month interval surface water time series records
...
/**
 * This class stores data for surface water station month interval time series data, for example see below.
