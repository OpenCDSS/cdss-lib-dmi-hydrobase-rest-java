// ColoradoHydroBaseRest_Structure_TableModel - table model for structure
...
{	
	...
	switch (col) {
		...
		case COL_START:
		    //return Integer.valueOf(mt.getStart_year() );
			i = mt.getStart_year();
		...
		case COL_END:
		    //return Integer.valueOf ( mt.getEnd_year() );
			i = mt.getEnd_year();
			if ( DMIUtil.isMissing(i) ) {
				return "";
			}
		...
		case COL_DIV:
		    //return Integer.valueOf ( mt.getDiv() );
			i = mt.getDiv();
			if ( DMIUtil.isMissing(i) ) {
				return "";
			}
		...
		case COL_DIST:
		    //return Integer.valueOf ( mt.getWD() );
			i = mt.getWD();
			if ( DMIUtil.isMissing(i) ) {
				return "";
			}
